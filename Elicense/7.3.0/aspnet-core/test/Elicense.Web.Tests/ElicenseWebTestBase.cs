...
{
    public abstract class ElicenseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ElicenseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ElicenseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ElicenseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ElicenseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ElicenseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ElicenseDbContext, Task<T>> func)
        {
            T result;
